...
class ApprovalProvenanceTests(unittest.TestCase):
    ...
    def github_attestation(self,reinforced=False):
        a={
            ...
            "workflow_file":{"path":".github/workflows/ci.yml","blob_sha":"blob123","size":73,"sha256":"5949de6344caa241ad89c8f9dfa16d52628f893809c8fc436cac9565c8f9fdb4","content_b64":"bmFtZTogQ0kKcGVybWlzc2lvbnM6CiAgY29udGVudHM6IHJlYWQKam9iczoKICB2YWxpZGF0ZToKICBweXRob24tdGVzdHM6Cg==","policy_validation":{"valid":True}},
