...
class EvolutionCandidateTests(unittest.TestCase):
    ...
    def test_completion_registry_smoke_and_evolution_judges_are_protected(self):
        for path in ('studio/completion.py','studio/stage_registry.py','studio/smoke.py','studio/evolution_differential.py','studio/evolution_isolated_runner.py','studio/godot_android_export.py','studio/godot_android_stage.py','studio/godot_device_qa.py','studio/godot_device_stage.py','studio/godot_runtime_journeys.py','studio/godot_runtime_journey_stage.py','studio/godot_visual_qa.py','studio/godot_visual_stage.py','studio/godot_release_qa.py','studio/godot_release_stage.py','studio/godot_release_artifact.py','studio/godot_release_artifact_stage.py','studio/engine_entry.py','studio/engine_detect.py','studio/multi_engine_orchestrator.py'): self.assertIn(path,PROTECTED_PATHS)
