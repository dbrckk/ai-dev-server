...
The bootstrap installs Asset Forge from the E2E-verified immutable revision `9fc828fafb50572d07d2ee747b0643c3fdcfd324` by default. Set `ASSET_FORGE_REF` only when intentionally testing another revision.
