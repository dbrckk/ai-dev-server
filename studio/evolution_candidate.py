...
def _validate_benchmark(content: str, gap: str) -> dict:
    ...
    if not isinstance(value,dict) or set(value)!=required or value.get('version')!=1: raise CandidateRejected('Candidate benchmark schema invalid')
